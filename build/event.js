...
var _aliases = __webpack_require__(88);
...
var store = exports.store = (0, _redux.createStore)(_reducers2.default, initialState, (0, _redux.applyMiddleware)((0, _reactChromeRedux.alias)(_aliases2.default), _reduxThunk2.default));
...
var getOrdersAlias = function getOrdersAlias(orginalAction) {
    return function (dispatch, getState) {
        (0, _data.getOrders)(dispatch);
    };
};
...
exports.removeFromStorage = exports.saveToStorage = exports.getFromStorage = exports.getYemeksepetiGlobals = undefined;
...
var _chromePromise = __webpack_require__(97);
...
var TOKEN_COOKIE_NAME = 'loginToken';
var CATALOG_COOKIE_NAME = 'catalogName';
var CULTURE_COOKIE_NAME = 'culture';

var chromep = new _chromePromise2.default();

var getYemeksepetiGlobals = exports.getYemeksepetiGlobals = function () {
    var _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(dispatch) {
        var token, catalog, culture, globals;
            ...
            while (1) {
                switch (_context.prev = _context.next) {
                    ...
                    case 2:
                        token = _context.sent;
                        _context.next = 5;
                        return getCookie(CATALOG_COOKIE_NAME);

                    case 5:
                        catalog = _context.sent;
                        _context.next = 8;
                        return getCookie(CULTURE_COOKIE_NAME);

                    case 8:
                        culture = _context.sent;
                        globals = { token: token, catalog: catalog, culture: culture };

                        dispatch((0, _actions.globalsRetrieved)(globals));

                        return _context.abrupt('return', globals);
    ...
    return function getYemeksepetiGlobals(_x) {
        return _ref.apply(this, arguments);
    };
}();

var getCookie = function () {
    var _ref2 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee2(cookieName) {
        var cookie;
            ...
            while (1) {
                switch (_context2.prev = _context2.next) {
                    ...
                    case 3:
                        ...
                        return _context2.abrupt('return', cookie.value);
                    ...
                    case 8:
                        ...
                        console.log("GetCookie Error", _context2.t0);
        ...
        return _regenerator2.default.wrap(function _callee3$(_context3) {
            while (1) {
                switch (_context3.prev = _context3.next) {
                    ...
                    case 2:
                        storageItem = _context3.sent;
                        itemFound = storageItem && storageItem[key];
                        ...
                        return _context3.abrupt('return', storageItem[key].data);
...
var saveToStorage = exports.saveToStorage = function () {
    var _ref4 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee4(key, data) {
        var expireTime, storageItem;
            ...
            while (1) {
                switch (_context4.prev = _context4.next) {
                    case 0:
                        ...
                        storageItem = (0, _defineProperty3.default)({}, key, { data: data, expireTime: expireTime.getTime() });
                        _context4.next = 5;
                        return chromep.storage.local.set(storageItem);
    ...
    return function saveToStorage(_x4, _x5) {
...
var removeFromStorage = exports.removeFromStorage = function () {
        ...
        return _regenerator2.default.wrap(function _callee5$(_context5) {
            while (1) {
                switch (_context5.prev = _context5.next) {
                    case 0:
                        _context5.next = 2;
                        return chromep.storage.local.remove(key);
    ...
    return function removeFromStorage(_x6) {
...
var _chrome = __webpack_require__(89);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var ordersApiAddress = 'http://api.yemeksepeti.com/YS.WebServices/OrderService.svc';

var getOrders = exports.getOrders = function () {
    var _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(dispatch) {
        var globals, cacheKey, savedOrders, apiResult, filteredData;
        return _regenerator2.default.wrap(function _callee$(_context) {
            while (1) {
                switch (_context.prev = _context.next) {
                    case 0:
                        _context.next = 2;
                        return (0, _chrome.getYemeksepetiGlobals)(dispatch);
                    ...
                    case 2:
                        ...
                        dispatch((0, _actions.ordersRetrieved)([]));
                        return _context.abrupt('return');

                    case 6:
                        cacheKey = 'Orders_' + globals.token + '_' + globals.catalog + '_' + globals.culture;
                        _context.next = 9;
                        return (0, _chrome.getFromStorage)(cacheKey);

                    case 9:
                        savedOrders = _context.sent;
                        ...
                        dispatch((0, _actions.ordersRetrieved)(savedOrders));
                        return _context.abrupt('return');

                    case 13:
                        _context.next = 15;
                        return getOrdersFromApi(globals);

                    case 15:
                        apiResult = _context.sent;
                        filteredData = apiResult.orders.filter(function (item) {
                        ...
                        _context.next = 20;
                        return (0, _chrome.saveToStorage)(cacheKey, filteredData);

                    case 20:

                        dispatch((0, _actions.ordersRetrieved)(filteredData));
...
var getOrdersFromApi = function () {
    var _ref2 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee2(globals) {
            ...
            while (1) {
                switch (_context2.prev = _context2.next) {
                    case 0:
                        ...
                        _context2.next = 5;
                        return _axios2.default.post(ordersApiAddress + '/GetOrderHistory', requestBody);
                    ...
                    case 5:
                        ...
                        return _context2.abrupt('return', { orders: response.data.d.ResultSet, success: true });
                    ...
                    case 10:
                        ...
                        console.log("GetOrders Error", _context2.t0);

                    case 13:
                        return _context2.abrupt('return', { orders: [], success: false });
    ...
    return function getOrdersFromApi(_x2) {
        return _ref2.apply(this, arguments);
    };
}();

var filterAndDispatch = function filterAndDispatch(dispatch, event, data) {
...
exports.default = function () {
  ...
  switch (action.type) {
    case _actions.GLOBALS_RETRIEVED:
...
var _globals = __webpack_require__(91);
...
exports.default = function () {
  ...
  switch (action.type) {
    case _actions.ORDERS_RETRIEVED:
...
module.exports = !__webpack_require__(5) && !__webpack_require__(41)(function () {
